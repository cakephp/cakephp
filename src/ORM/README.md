...
[documentation](https://book.cakephp.org/5/en/orm/associations.html) for
complete examples.
...
You can use the [query builder](https://book.cakephp.org/5/en/orm/query-builder.html) to create
complex queries, and a [variety of methods](https://book.cakephp.org/5/en/orm/retrieving-data-and-resultsets.html)
to access your data.
...
associations in a simple & powerful way. Consult the [ORM documentation](https://book.cakephp.org/5/en/orm/saving-data.html)
...
Consult [the CakePHP ORM documentation](https://book.cakephp.org/5/en/orm.html)
