...
class Oauth
{
     ...
     */
    protected function plaintext(Request $request, #[SensitiveParameter] array $credentials): string
    {
        $values = [
            'oauth_version' => '1.0',
            'oauth_nonce' => uniqid(),
     ...
     * @return string
     */
    protected function hmacSha1(Request $request, #[SensitiveParameter] array $credentials): string
    {
     ...
     * @return string
     */
    protected function rsaSha1(Request $request, #[SensitiveParameter] array $credentials): string
    {
