...
trait CellTrait
{
     ...
     * @return \Cake\View\Cell<\Cake\View\View<\Cake\View\View>> The cell instance
     ...
     * @return \Cake\View\Cell<\Cake\View\View<\Cake\View\View>>
     * @phpstan-ignore missingType.generics (self-referential generic)
     */
    protected function _createCell(string $className, string $action, ?string $plugin, array $options): Cell
    {
        ...
        /** @var \Cake\View\Cell<\Cake\View\View<\Cake\View\View>> $instance @phpstan-ignore missingType.generics */
