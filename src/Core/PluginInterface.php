...
interface PluginInterface
{
     ...
     * @var array<string>
     */
    public const array VALID_HOOKS = ['bootstrap', 'console', 'middleware', 'routes', 'services', 'events'];
     ...
     *
     * @param \Cake\Container\ContainerInterface $container Container instance.
     * @return void
     */
