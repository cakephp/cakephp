...
class PluralRules
{
    ...
    public static function calculate(string $locale, int $n): int
    {
        ...
        if (!isset(static::$rulesMap[$locale]) && !isset(static::$callableRulesMap[$locale])) {
        ...
        return match (static::$rulesMap[$locale]) {
            ...
            16 => $n === 0 || $n === 1 ? 0 : ($n % 1_000_000 === 0 ? 1 : 2),
            17 => $n === 1 ? 0 : ($n !== 0 && $n % 1_000_000 === 0 ? 1 : 2),
