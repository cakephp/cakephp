...
class AttributeCollection implements IteratorAggregate, Countable
{
     ...
     *
     * @var array<int, \Cake\Attribute\Resolver\ValueObject\AttributeInfo>
     */
     ...
     * Constructor.
     *
     * @param iterable<\Cake\Attribute\Resolver\ValueObject\AttributeInfo|array> $items Items to populate the collection
     ...
     *
     * @param int $id Item ID
     * @return \Cake\Attribute\Resolver\ValueObject\AttributeInfo
     */
     ...
     *
     * @return \Cake\Attribute\Resolver\ValueObject\AttributeInfo|null
     */
     ...
     *
     * @return array<int, \Cake\Attribute\Resolver\ValueObject\AttributeInfo>
     */
