...
class Validator implements ArrayAccess, IteratorAggregate, Countable
{
     ...
     * @return $this
     */
    public function addNested(string $field, Validator $validator, ?string $message = null, callable|string|null $when = null)
    {
     ...
     * @return $this
     */
    public function addNestedMany(string $field, Validator $validator, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['message' => $message, 'on' => $when]);
     ...
     * @return $this
     */
    public function allowEmptyFor(string $field, ?int $flags = null, callable|string|bool $when = true, ?string $message = null)
    {
     ...
     */
    protected function _convertValidatorToArray(string|int $fieldName, array $defaults = [], array|string $settings = []): array
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function lengthBetween(string $field, array $range, ?string $message = null, callable|string|null $when = null)
    {
        if (count($range) !== 2) {
     ...
     * @return $this
     */
    public function creditCard(string $field, string $type = 'all', ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function greaterThan(string $field, float|int $value, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function greaterThanOrEqual(string $field, float|int $value, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function lessThan(string $field, float|int $value, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function lessThanOrEqual(string $field, float|int $value, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function equals(string $field, float|int $value, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function notEquals(string $field, float|int $value, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function sameAs(string $field, string $secondField, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @since 3.6.0
     */
    public function notSameAs(string $field, string $secondField, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @since 3.6.0
     */
    public function equalToField(string $field, string $secondField, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @since 3.6.0
     */
    public function notEqualToField(string $field, string $secondField, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @since 3.6.0
     */
    public function greaterThanField(string $field, string $secondField, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @since 3.6.0
     */
    public function greaterThanOrEqualToField(string $field, string $secondField, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @since 3.6.0
     */
    public function lessThanField(string $field, string $secondField, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @since 3.6.0
     */
    public function lessThanOrEqualToField(string $field, string $secondField, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function date(string $field, array $formats = ['ymd'], ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function dateTime(string $field, array $formats = ['ymd'], ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function localizedTime(string $field, string $type = 'datetime', ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function decimal(string $field, ?int $places = null, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function email(string $field, bool $checkMX = false, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function uploadedFile(string $field, array $options, ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
     ...
     * @return $this
     */
    public function multipleOptions(string $field, array $options = [], ?string $message = null, callable|string|null $when = null)
    {
        $extra = array_filter(['on' => $when, 'message' => $message]);
