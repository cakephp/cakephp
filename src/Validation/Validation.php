...
class Validation
{
     ...
     * @param string|array $type  'all' may be passed as a string, defaults to fast which checks format of most major
     *                            credit cards if an array is used only the values of the array are checked. Example:
     *                            ['amex', 'bankcard', 'maestro']
     * @param bool         $deep  set to true this will check the Luhn algorithm of the credit card.
     * @param string|null  $regex A custom regex can also be passed, this will be used instead of the defined regex
     *                            values
     *
     * @return bool Success
     ...
     * @param string|null               $regex  If a custom regular expression is used this is the only validation that
     *                                          will occur.
     *
     * @return bool Success
     */
     ...
     * @param array|string                                         $mimeTypes Array of mime types or regex pattern to
     *                                                                        check.
     *
     * @return bool Success
     ...
     * @param int|string|null                                      $size     Size in bytes or human readable string
     *                                                                       like '5MB'.
     *
     * @return bool Success
     */
     ...
     *
     * @param string|array|\Psr\Http\Message\UploadedFileInterface $check       Value to check.
     * @param bool                                                 $allowNoFile Set to true to allow UPLOAD_ERR_NO_FILE
     *                                                                          as a pass.
     *
     * @return bool
