...
class Validation
{
     ...
     */
    public static function creditCard(mixed $check, array|string $type = 'fast', bool $deep = false, ?string $regex = null): bool
    {
     ...
     * @return bool Success
     */
    public static function comparison(string|int $check1, string $operator, string|int $check2): bool
    {
        if (
     ...
     * @return bool Success.
     */
    public static function boolean(string|int|bool $check, array $booleanValues = []): bool
    {
        if (!$booleanValues) {
     ...
     * @return bool Success.
     */
    public static function truthy(string|int|bool $check, array $truthyValues = []): bool
    {
        if (!$truthyValues) {
     ...
     * @return bool Success.
     */
    public static function falsey(string|int|bool $check, array $falseyValues = []): bool
    {
        if (!$falseyValues) {
     ...
     * @return bool Success
     */
    public static function extension(UploadedFileInterface|array|string $check, array $extensions = ['gif', 'jpeg', 'png', 'jpg']): bool
    {
     ...
     */
    public static function mimeType(UploadedFileInterface|array|string $check, array|string $mimeTypes = []): bool
    {
     ...
     * @return bool Success
     */
    public static function fileSize(UploadedFileInterface|array|string $check, string $operator, string|int $size): bool
    {
        $file = static::getFilename($check);
        if ($file === false) {
            return false;
     ...
     */
    public static function uploadError(UploadedFileInterface|array|string $check, bool $allowNoFile = false): bool
    {
        if ($check instanceof UploadedFileInterface) {
            $code = $check->getError();
