...
trait ModelAwareTrait
{
    ...
    /**
     * @param string|null $modelClass Name of model class. Defaults to $this->modelClass.
     * @param string|null $modelType The type of repository. Defaults to the getModelType() value.
