...
class MergeVariablesTraitTest extends TestCase
{
    ...
    public function testMergeVarsAsList(): void
    {
        ...
        $object->publicMergeVars(['listProperty']);
    ...
    {
        $object = new Grandchild();
        $object->publicMergeVars(['assocProperty'], ['associative' => ['assocProperty']]);
        $expected = [
            'Red' => null,
            'Orange' => null,
            'Green' => ['apple'],
    ...
    {
        $object = new Grandchild();
        $object->publicMergeVars(['nestedProperty'], ['associative' => ['nestedProperty']]);
    ...
    {
        $object = new Grandchild();
        $object->publicMergeVars(['assocProperty', 'listProperty'], ['associative' => ['assocProperty']]);
        $expected = [
            'Red' => null,
            'Orange' => null,
            'Green' => ['apple'],
    ...
    {
        $object = new Child();
        $object->publicMergeVars(['hasBoolean']);
