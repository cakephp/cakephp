...
class HtmlExceptionRendererTest extends TestCase
{
    /**
     * @var bool
     */
    ...
    public function testControllerInstanceForPrefixedRequest(): void
    {
        ...
        $this->assertInstanceOf(
            ...
            $renderer->__debugInfo()['controller']
        );
    ...
    public function testTemplatePath(): void
    {
        ...
        $renderer = new HtmlExceptionRenderer($exception, $request);
    ...
    {
        $exception = new NotFoundException('Page not found');
        $renderer = new HtmlExceptionRenderer($exception);

        $this->assertInstanceOf(
            'Cake\Controller\ErrorController',
            $renderer->__debugInfo()['controller']
        );
        $this->assertEquals($exception, $renderer->__debugInfo()['error']);
    }
    ...
    public function testExceptionMessageCoercion(): void
    {
        ...
        $result = (string)$renderer->render()->getBody();

        $this->assertSame('error400', $renderer->__debugInfo()['template']);
    ...
    public function testUnknownExceptionTypeWithExceptionThatHasA400Code(): void
    {
        ...
        $this->assertFalse(method_exists($renderer, 'missingWidgetThing'), 'no method should exist.');
    ...
    {
        $exceptionRenderer = new HtmlExceptionRenderer($exception);
    ...
    public function testRenderInheritRoutingParams(): void
    {
        ...
        $exceptionRenderer = new HtmlExceptionRenderer(new Exception('Terrible'), new ServerRequest());
