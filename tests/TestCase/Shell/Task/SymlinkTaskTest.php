...
class SymlinkTaskTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->skipIf(
                DS === '\\', 'Skip Symlink Task tests on windows to prevent side effects for UrlHelper tests on AppVeyor.'
        );

        $this->io = $this->getMock('Cake\Console\ConsoleIo', [], [], '', false);

        $this->shell = $this->getMock(
                'Cake\Shell\PluginShell', ['in', 'out', 'err', '_stop', 'symlink'], [$this->io]
        );
    }
    ...
    public function testSymlinkWhenTargetAlreadyExits()
    {
        ...
        $shell = $this->getMock(
                'Cake\Shell\PluginAssetsShell', ['in', 'out', 'err', '_stop', '_createSymlink', '_copyDirectory'], [$this->io]
        );
    ...
    public function testSymlinkingSpecifiedPlugin()
    {
        ...
        $this->shell->Symlink->main('TestPlugin');
