...
class CollectionTest extends TestCase
{
    ...
    {
        $this->assertSame(333, new Collection()->median('invoice.total'));
    }
    ...
    {
        $collection = new Collection()->shuffle();
    ...
    {
        $collection = new Collection()->append(['a' => 2])->shuffle();
        $result = $collection->toArray();
    ...
    {
        $result = new Collection()->sample(2)->toArray();
        $this->assertCount(2, $result);
    ...
    public function testBuffered(): void
    {
        ...
        $buffered = new Collection()->buffered();
    ...
    public function testCombine(): void
    {
        ...
        $collection = new Collection()->combine('id', 'name');
        $expected = [1 => 'foo', 2 => 'bar', 3 => 'baz'];
        $this->assertEquals($expected, $collection->toArray());

        $expected = ['foo' => 1, 'bar' => 2, 'baz' => 3];
        $collection = new Collection()->combine('name', 'id');
        $this->assertEquals($expected, $collection->toArray());

        $collection = new Collection()->combine('id', 'name', 'parent');
        ...
        $collection = new Collection()->combine(
            function ($value, $key) {
    ...
    {
        $collection = new Collection()->combine('type', 'amount');
    ...
    public function testCombineNullKey(): void
    {
        ...
        new Collection()->combine('id', 'name');
    }
    ...
    public function testCombineNullGroup(): void
    {
        ...
        new Collection()->combine('id', 'name', 'parent');
    }
    ...
    public function testNest(): void
    {
        ...
        $collection = new Collection()->nest('id', 'parent_id');
        $expected = [
            [
                'id' => 1,
                'parent_id' => null,
    ...
    public function testNestAlternateNestingKey(): void
    {
        ...
        $collection = new Collection()->nest('id', 'parent_id', 'nodes');
        $expected = [
            [
                'id' => 1,
                'parent_id' => null,
    ...
    public function testListNested(string $dir, array $expected): void
    {
        ...
        $collection = new Collection()->nest('id', 'parent_id')->listNested($dir);
    ...
    public function testListNestedSpacer(): void
    {
        ...
        $collection = new Collection()->nest('id', 'parent_id')->listNested();
        $expected = [
            'Birds',
            '---Land Birds',
            '---Eagle',
    ...
    public function testListNestedCustomKey(): void
    {
        ...
        $collection = new Collection()->listNested('desc', 'stuff');
    ...
    public function testListNestedWithCallable(): void
    {
        ...
        $collection = new Collection()->listNested('desc', function ($item) {
            return $item['stuff'] ?? [];
        });
        $this->assertEquals(range(1, 5), $collection->extract('id')->toArray(false));
    }
    ...
    {
        $this->assertEquals($expected, new Collection()->sumOf('invoice.total'));
    }
    ...
    {
        $sum = new Collection()->sumOf(function ($v) {
    ...
    {
        $collection = new Collection()->stopWhen(function ($v) {
            return $v > 3;
        });
    ...
    public function testStopWhenWithArray(): void
    {
        ...
        $collection = new Collection()->stopWhen(['foo' => 'baz']);
    ...
    public function testUnfold(): void
    {
        ...
        $collection = new Collection()->unfold();
    ...
    {
        $items = [1, 2, 3];
        $collection = new Collection()->unfold(function ($item) {
    ...
    {
        $items = [1, 2, 3];
        $collection = new Collection()->through(function ($collection) {
    ...
    public function testUnfoldedExtract(): void
    {
        ...
        $extracted = new Collection()->extract('comments.{*}.id');
        ...
        $extracted = new Collection()->extract('comments.{*}.voters.{*}.id');
    ...
    {
        $items = ['a' => 1, 'b' => 2, 'c' => 3];
        $collection = new Collection()->lazy();
        $callable = new class {
