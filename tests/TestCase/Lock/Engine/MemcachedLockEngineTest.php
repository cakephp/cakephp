...
class MemcachedLockEngineTest extends TestCase
{
     ...
     */
    protected ?MemcachedLockEngine $engine = null;
    ...
    protected function setUp(): void
    {
        ...
        $this->engine = new MemcachedLockEngine();
    ...
    {
        // Unfortunately Memcached doesn't support key listing
        // We'll rely on TTL-based expiration for cleanup
        $this->engine->forceRelease('test-resource');
        $this->engine->forceRelease('resource-1');
        $this->engine->forceRelease('resource-2');
        $this->engine->forceRelease('resource-3');
    }
