...
class TableTest extends TestCase
{
    ...
    public function testFindBeforeFindEventOverrideReturn(): void
    {
        ...
        $query = $table->find('all')
            ->formatResults(fn(ResultSetDecorator $results): ResultSetDecorator => $results);
        $query->limit(1);
    ...
    public function testReciprocalHasManyLoading(): void
    {
        ...
        $this->assertContainsOnlyInstancesOf(Article::class, $result->author->articles);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('The `' . Table::class . '::validationMissing()` validation method does not exists.');
        $table = new Table();
