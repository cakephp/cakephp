...
use TestPluginTwo\Model\Table\CommentsTable as TableTwoCommentsTable;
...
class TableLocatorTest extends TestCase
{
    ...
    public function testGetMultiplePlugins(): void
    {
        ...
        $this->assertInstanceOf(TableTwoCommentsTable::class, $plugin2, 'Should be a plugin 2 table instance');
        ...
        $this->assertInstanceOf(TableTwoCommentsTable::class, $plugin2, 'Should still be a plugin 2 table instance');
    }
