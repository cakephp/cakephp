...
class CommonTableExpressionIntegrationTest extends TestCase
{
    ...
    {
        $expression = $this->connection->newQuery()->commonTableExpression('cte', 'SELECT 1');
    ...
    public function testCommonTableExpressionWithQueryAsClosure()
    {
        $expression = $this->connection
            ->newQuery()
            ->commonTableExpression('cte', function (QueryExpression $exp, Query $query) {
                return 'SELECT 1';
            });
    ...
    public function testWithReset(): void
    {
        ...
        $query
            ->with(function (QueryExpression $exp, Query $query) {
                return $query
                    ->commonTableExpression('cte1', 'SELECT 1 AS col');
            })
            ->select('col')
            ->from('cte');
    ...
    public function testWithOverwrite(): void
    {
        ...
        $query->with(function (QueryExpression $exp, Query $query) {
            return $query
                ->commonTableExpression('cte2', 'SELECT 2 AS col');
        });
        ...
        $query->with(
            function (QueryExpression $exp, Query $query) {
                return $query
                    ->commonTableExpression('cte1', 'SELECT 3 AS col');
            },
            true
        );
    ...
    public function testWithInInsertQuery()
    {
        ...
        $query = $this->connection
            ...
            ->with(function (QueryExpression $exp, Query $query) {
                return $query
                    ->commonTableExpression('cte', "SELECT 'Fourth Article', 'Fourth Article Body'")
    ...
    public function testWithInUpdateQuery()
    {
        ...
        $query = $this->connection
            ->newQuery()
            ->with(function (QueryExpression $exp, Query $query) {
                return $query->commonTableExpression(
                    'cte',
                    $query
                        ->getConnection()
                        ->newQuery()
    ...
    public function testTraverse(): void
    {
        ...
        $cte2 = new CommonTableExpression('cte2', 'SELECT 1');
        $query = $this->connection
            ->newQuery()
            ->with($cte1)
            ->with($cte2)
    ...
    public function testClone(): void
    {
        ...
        $this->assertEquals('SELECT 1', $with->getExpressions()[0]->getQuery());
        ...
        $this->assertEquals('SELECT 1', $with->getExpressions()[1]->getQuery());
    }
}
