...
class HeaderUtilityTest extends TestCase
{
    ...
    public function testLink(): void
    {
        ...
        $this->assertSame($expected, HeaderUtility::link($new->getHeader('Link')));
    ...
    public function testQualifiers(): void
    {
        ...
        $result = HeaderUtility::qualifiers($request->getHeaderLine('Accept'));
        $expected = [
            '0.6' => ['application/xml'],
    ...
    {
        $result = HeaderUtility::wwwAuthenticate('Digest realm="The batcave",nonce="4cded326c6c51"');
        $expected = [
            'realm' => 'The batcave',
            'nonce' => '4cded326c6c51',
        ];
    ...
    {
        $result = HeaderUtility::wwwAuthenticate('Digest qop="auth", realm="shellyplus1pm-44179393e8a8", nonce="63f8c86f", algorithm=SHA-256');
        $expected = [
            'qop' => 'auth',
