 ...
 */
	public function testGetTemplate() {
		...
		$expected = TEST_APP . 'src' . DS . 'View' . DS . 'Pages' . DS . 'home.ctp';
		$result = $ThemeView->getViewFileName('home');
		$this->assertEquals($expected, $result);

		$expected = TEST_APP . 'src' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Posts' . DS . 'index.ctp';
		$result = $ThemeView->getViewFileName('/Posts/index');
		$this->assertEquals($expected, $result);

		$expected = TEST_APP . 'src' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Layout' . DS . 'default.ctp';
		$result = $ThemeView->getLayoutFileName();
		$this->assertEquals($expected, $result);

		$ThemeView->layoutPath = 'rss';
		$expected = TEST_APP . 'src' . DS . 'View' . DS . 'Layout' . DS . 'rss' . DS . 'default.ctp';
		$result = $ThemeView->getLayoutFileName();
		$this->assertEquals($expected, $result);

		$ThemeView->layoutPath = 'Email' . DS . 'html';
		$expected = TEST_APP . 'src' . DS . 'View' . DS . 'Layout' . DS . 'Email' . DS . 'html' . DS . 'default.ctp';
		$result = $ThemeView->getLayoutFileName();
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testPluginThemedGetTemplate() {
		...
		$ThemeView = new TestThemeView($this->Controller);
		$themePath = TEST_APP . 'src' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS;
 ...
 */
	public function testPluginPathGeneration() {
		...
		$expected = array(
			TEST_APP . 'src' . DS . 'View' . DS . 'Plugin' . DS . 'TestPlugin' . DS,
			$pluginPath . 'View' . DS,
			TEST_APP . 'src' . DS . 'View' . DS,
			CAKE . 'View' . DS,
		);
		$this->assertEquals($expected, $paths);
	}
 ...
 */
	public function testCamelCasePluginGetTemplate() {
		...
		$pluginPath = Plugin::path('TestPlugin');
		$expected = TEST_APP . 'plugins' . DS . 'TestPlugin' . DS . 'View' . DS . 'Tests' . DS . 'index.ctp';
		$result = $View->getViewFileName('index');
		$this->assertEquals($expected, $result);
 ...
 */
	public function testGetViewFileNames() {
		...
		$expected = TEST_APP . 'src' . DS . 'View' . DS . 'Posts' . DS . 'index.ctp';
		...
		$expected = TEST_APP . 'src' . DS . 'View' . DS . 'Pages' . DS . 'page.home.ctp';
 ...
 */
	public function testGetLayoutFileName() {
		...
		$expected = TEST_APP . 'src' . DS . 'View' . DS . 'Layout' . DS . 'default.ctp';
		$result = $View->getLayoutFileName();
		$this->assertEquals($expected, $result);
 ...
 */
	public function testGetLayoutFileNamePlugin() {
		...
		$expected = TEST_APP . 'plugins' . DS . 'TestPlugin' . DS . 'View' . DS . 'Layout' . DS . 'default.ctp';
 ...
 */
	public function testGetViewFileNameSubdirWithPluginAndViewPath() {
		...
		$View = new TestView($this->PostsController);
		$pluginPath = TEST_APP . 'plugins' . DS . 'TestPlugin' . DS;
