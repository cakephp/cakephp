...
class FormHelperTest extends TestCase
{
    ...
    /**
     * Test that `{{name}}` template variable is available in inputContainer template.
     */
    public function testControlNameTemplateVar(): void
    {
        $result = $this->Form->control('title', [
            'templates' => [
                'inputContainer' => '<div class="input {{type}}" data-field="{{name}}">{{content}}</div>',
            ],
        ]);
        $this->assertStringContainsString('data-field="title"', $result);
        ...
        $this->assertStringContainsString('data-field="User[email]"', $result);
        ...
        $this->assertStringContainsString('data-field="User[address][city]"', $result);
    }

    /**
     * Test that `{{name}}` template variable is available in error template.
     */
    public function testErrorNameTemplateVar(): void
    {
        $this->article['errors'] = [
            'title' => ['error message'],
        ];
        ...
        $result = $this->Form->control('title', [
            'templates' => [
                'error' => '<div class="error" data-field="{{name}}">{{content}}</div>',
            ],
        ]);
        $this->assertStringContainsString('data-field="title"', $result);
    ...
    /**
     * Test that `{{name}}` template variable works with nested field names in error template.
     */
    public function testErrorNameTemplateVarNested(): void
    {
        $this->article['errors'] = [
            'author' => [
        ...
        $this->assertStringContainsString('data-field="author[name]"', $result);
        $this->assertStringContainsString('Author name is required', $result);
    }
