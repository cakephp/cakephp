 ...
 */
	public function testMapCoreTestToCategory() {
		...
		$return = $this->Shell->mapFileToCategory('Test/TestCase/BasicsTest.php');
		$this->assertSame('core', $return);

		$return = $this->Shell->mapFileToCategory('Test/TestCase/BasicsTest.php');
		$this->assertSame('core', $return);

		$return = $this->Shell->mapFileToCategory('Test/TestCase/Some/Deeply/Nested/StructureTest.php');
		$this->assertSame('app', $return);
	}
