 ...
 */
	public function testExecute() {
		...
		$this->Task->params['paths'] = TEST_APP . 'src/View/Pages';
 ...
 */
	public function testExtractCategory() {
		...
		$this->Task->params['paths'] = TEST_APP . 'src' . DS . 'View' . DS . 'Pages';
		$this->Task->params['output'] = $this->path . DS;
		$this->Task->params['extract-core'] = 'no';
 ...
 */
	public function testExtractWithExclude() {
		...
		$this->Task->params['paths'] = TEST_APP . 'src/View';
		$this->Task->params['output'] = $this->path . DS;
 ...
 */
	public function testExtractMultiplePaths() {
		...
		$this->Task->params['paths'] =
			TEST_APP . 'src/View/Pages,' .
			TEST_APP . 'src/View/Posts';
 ...
 */
	public function testExtractExcludePlugins() {
		...
		$this->Task->params['paths'] = TEST_APP . 'src/';
		$this->Task->params['output'] = $this->path . DS;
