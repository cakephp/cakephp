...
class TestView extends AppView
{
     ...
     */
    public function publicGetTemplateFileName(?string $name = null): string
    {
     ...
     */
    public function publicGetLayoutFileName(?string $name = null): string
    {
     ...
     * @return string[] paths
     */
    public function publicPaths(?string $plugin = null, bool $cached = true): array
    {
