...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>CakePHP Test Suite <?= Configure::version(); ?></title>
		<style type="text/css">
			body h2 {color: #777;}
			...
			ul.tests li.skipped,
			ul.tests li.fail {
				background: #fff2f2 url(<?= $baseDir; ?>img/test-fail-icon.png) 5px 5px no-repeat;
			...
			ul.tests li.pass {
				...
				background-image: url(<?= $baseDir; ?>img/test-pass-icon.png);
				border-color:green;
			}
			ul.tests li.skipped {
				background-color: #edf1ff;
				background-image: url(<?= $baseDir; ?>img/test-skip-icon.png);
				border-color:navy;
			}
			ul.tests li.error {
				background-color: #ffffe5;
				background-image: url(<?= $baseDir; ?>img/test-error-icon.png);
				border-color: #DF6300;
			}
		...
		<link rel="stylesheet" type="text/css" href="<?= $baseDir; ?>css/cake.generic.css" />
	</head>
	<body>
		<div id="container">
			<div id="header">
			<div id="version">PHPUnit: <?= class_exists('PHPUnit_Runner_Version') ? PHPUnit_Runner_Version::id() : 'n/a'; ?></div>
				<h1>CakePHP: the rapid development php framework</h1>
			</div>
			<div id="content">
			<h2>CakePHP Test Suite <?= Configure::version(); ?></h2>
