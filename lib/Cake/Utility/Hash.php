 ...
 * @param array|string|array $keyPath A dot-separated string or array for formatting rules.
 * @param array|string|array $valuePath A dot-separated string or array for formatting rules.
