 ...
 */
	function __($singular, $args = null) {
		...
		return I18n::insertTranslationArguments($translated, array_slice($arguments, 1));
	}
 ...
 */
	function __n($singular, $plural, $count, $args = null) {
		...
		$arguments = func_get_args();
		return I18n::insertTranslationArguments($translated, array_slice($arguments, 3));
	}
 ...
 */
	function __d($domain, $msg, $args = null) {
		...
		$arguments = func_get_args();
		return I18n::insertTranslationArguments($translated, array_slice($arguments, 2));
	}
 ...
 */
	function __dn($domain, $singular, $plural, $count, $args = null) {
		...
		$arguments = func_get_args();
		return I18n::insertTranslationArguments($translated, array_slice($arguments, 4));
	}
 ...
 */
	function __dcn($domain, $singular, $plural, $count, $category, $args = null) {
		...
		$arguments = func_get_args();
		return I18n::insertTranslationArguments($translated, array_slice($arguments, 5));
	}
