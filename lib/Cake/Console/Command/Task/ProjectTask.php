	...
	public function execute() {
		...
		if ($this->bake($project)) {
			...
			if ($this->securitySalt($path) === true) {
				...
				$this->err(__d('cake_console', 'Unable to generate random hash for \'Security.salt\', you should change it in %s', CONFIG . DS . 'core.php'));
				$success = false;
			}
			...
			if ($this->securityCipherSeed($path) === true) {
				...
				$this->err(__d('cake_console', 'Unable to generate random seed for \'Security.cipherSeed\', you should change it in %s', CONFIG . DS . 'core.php'));
				$success = false;
			}
 ...
 */
	public function cakeAdmin($name) {
		$path = (empty($this->configPath)) ? CONFIG . DS : $this->configPath;
