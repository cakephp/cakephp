...
return Architecture::define()
    ...
    ->ruleset([
        ...
        'Console' => ['Command', 'Container', 'Database', 'Error', '+Event', 'Log', 'Routing', 'Utility'],
        'Container' => [],
        'Controller' => ['Container', 'Datasource', '+Event', 'Form', 'Http', 'Log', 'ORM', 'Routing', 'Utility', 'View'],
        ...
        'Error' => ['Container', 'Controller', 'Database', '+Log', '+Routing', 'View'],
        'Event' => ['Container', 'Core'],
        'Form' => ['+Event', 'Utility', 'Validation'],
        'Http' => ['+Cache', 'Console', 'Container', 'Controller', 'Datasource', 'Error', 'I18n', 'ORM', 'Routing'],
        ...
        'TestSuite' => ['Collection', 'Container', 'Controller', 'Database', 'Datasource', 'Error', '+Event', 'Form', 'Http', 'Log', 'Mailer', 'ORM', 'Routing', 'Utility'],
        'Utility' => ['Core', 'I18n'],
