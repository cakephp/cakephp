...
PHP 8.1 reached end of life on 31 December 2025. Its image uses the final official PHP 8.1.34 base, so weekly rebuilds **cannot provide new PHP 8.1 security fixes**. It is for legacy CakePHP applications; the current CakePHP `5.x` branch requires PHP 8.2 or newer.
